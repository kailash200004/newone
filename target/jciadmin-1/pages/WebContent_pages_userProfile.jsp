                ...
                <div class="row">
                    <div class="col-md-11">
                        <div class="ibox">
                            <span>${msg}</span>
                            <div class="ibox-body">
                                <form action="edituserProfile.obj" method="POST">
                                    <div class="row">
                          ...
                          <div class="col-sm-4 form-group">
                                    ...
                                    <div class="form-group col-sm-12">
                                     <a href="edituserProfile.obj?id=<%=(int)session.getAttribute("refId")%>"><button class="btn btn-default" type="button">Edit</button></a>
                                    </div>
                                </form>
                            </div>
                        </div>

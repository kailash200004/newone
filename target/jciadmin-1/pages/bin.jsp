								...
								<form action="saveBinDetails.obj" method="POST">
									<div class="row">
										<div class="col-sm-4 form-group">
											<label>Name of Dpc</label> <input id="dpcname"  readonly class="form-control"
												type="text" name="dpcname" value="<%
												String username = (String) request.getSession().getAttribute("dpcId");
												out.print(username);
												%>" placeholder="DPC Name" required>
										</div>
										<div class="col-sm-4 form-group">

...
public class MarketArrivalModel {
	...
	public String toString() {
		return "MarketArrivalModel [mrarefid=" + mrarefid + ", grade1=" + grade1 + ", grade2=" + grade2 + ", grade3="
				+ grade3 + ", grade4=" + grade4 + ", grade5=" + grade5 + ", grade6=" + grade6 + ", grade7=" + grade7
				+ ", grade8=" + grade8 + ", grade_rate1=" + grade_rate1 + ", grade_rate2=" + grade_rate2
				+ ", grade_rate3=" + grade_rate3 + ", grade_rate4=" + grade_rate4 + ", grade_rate5=" + grade_rate5
				+ ", grade_rate6=" + grade_rate6 + ", grade_rate7=" + grade_rate7 + ", grade_rate8=" + grade_rate8
				+ ", dpcnames=" + dpcnames + ", region_id=" + region_id + ", datearrival=" + datearrival + ", basis="
				+ basis + ", jutevariety=" + jutevariety + ", cropyr=" + cropyr + ", arrivedqty=" + arrivedqty
				+ ", mixmois=" + mixmois + ", maxmois=" + maxmois + ", createddate=" + createddate + ", creadtedby="
				+ creadtedby + ", no_arrival=" + no_arrival + "]";
	}

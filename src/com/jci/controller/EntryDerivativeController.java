...
public class EntryDerivativeController {
	...
	public ModelAndView saveEDC(HttpServletRequest request, RedirectAttributes redirectAttributes) {
		...
		try {
			EntryDerivativePrice entryDerivativePrice = new EntryDerivativePrice();
			String crop_year = request.getParameter("crop_year");
			String state = request.getParameter("state");
			String district = request.getParameter("district");
			String delibry_type = request.getParameter("delibry_type");
			String tgr1 = request.getParameter("tgr1");
			String tgr2 = request.getParameter("tgr2");
			String tgr3 = request.getParameter("tgr3");
			String tgr4 = request.getParameter("tgr4");
			String tgr5 = request.getParameter("tgr5");
			String wgr1 = request.getParameter("wgr1");
			String wgr2 = request.getParameter("wgr2");
			String wgr3 = request.getParameter("wgr3");
			String wgr4 = request.getParameter("wgr4");
			String wgr5 = request.getParameter("wgr5");
			String mgr1 = request.getParameter("mgr1");
			String mgr2 = request.getParameter("mgr2");
			String mgr3 = request.getParameter("mgr3");
			String mgr4 = request.getParameter("mgr4");
			String mgr5 = request.getParameter("mgr5");
			String mgr6 = request.getParameter("mgr6");
			String bgr1 = request.getParameter("bgr1");
			String bgr2 = request.getParameter("bgr2");
			String bgr3 = request.getParameter("bgr3");
			...
			entryDerivativePrice.setTgr4(tgr4);
			entryDerivativePrice.setTgr5(tgr5);
			entryDerivativePrice.setWgr1(wgr1);
			entryDerivativePrice.setWgr2(wgr2);
			entryDerivativePrice.setWgr3(wgr3);
			entryDerivativePrice.setWgr4(wgr4);
			entryDerivativePrice.setWgr5(wgr5);
			entryDerivativePrice.setMgr1(mgr1);
			entryDerivativePrice.setMgr2(mgr2);
			entryDerivativePrice.setMgr3(mgr3);
			entryDerivativePrice.setMgr4(mgr4);
			entryDerivativePrice.setMgr5(mgr5);
			entryDerivativePrice.setMgr6(mgr6);
			entryDerivativePrice.setBgr1(bgr1);
			entryDerivativePrice.setBgr2(bgr2);
			entryDerivativePrice.setBgr3(bgr3);
		...
		return new ModelAndView(new RedirectView("entry_derivativeprice.obj"));
	}

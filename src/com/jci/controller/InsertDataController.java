...
//	private final String farmerUpload = "/Users/Animesh Anand/Desktop/FarmerRegistration";
	...
	// private final String slipUpload =
	// "C:\\Users\\apache-tomcat-8.5.70\\webapps\\TallySlip\\";
	...
	public ModelAndView saveBalePreparation(HttpServletRequest request, RedirectAttributes redirectAttributes) {
		...
		/*
		 * int creadtedby = 0; String dpcname = request.getParameter("dpcname"); String
		 * cropyr = request.getParameter("cropyr"); String jutevariety =
		 * request.getParameter("jutevariety"); String binnumb =
		 * request.getParameter("binnumb"); String basis =
		 * request.getParameter("basis"); String carryforward =
		 * request.getParameter("carryforward"); String carryforwarsrope =
		 * request.getParameter("carryforwarsrope"); BalePreparation balePrepare = new
		 * BalePreparation(); balePrepare.setDpcnames(dpcname);
		 * balePrepare.setCropyr(cropyr); balePrepare.setJutevariety(jutevariety);
		 * balePrepare.setBinnumber(binnumb); balePrepare.setBasis(basis);
	...
	public ModelAndView saveBaleList(HttpServletRequest request, RedirectAttributes redirectAttributes) {
		ModelAndView mv = new ModelAndView();
		/*
		 * try { String id = request.getParameter("id"); String dpcname =
		 * request.getParameter("dpcname"); String cropyr =
		 * request.getParameter("cropyr"); String binnumb =
		 * request.getParameter("binnumb"); String jutevariety =
		 * request.getParameter("jutevariety"); String basis =
		 * request.getParameter("basis"); String carryforward =
		 * request.getParameter("carryforward"); String carryforwarsrope =
		 * request.getParameter("carryforwarsrope"); BalePreparation balePrepare = new
		 * BalePreparation(); balePrepare.setId(Integer.parseInt(id));
		 * balePrepare.setDpcnames(dpcname); balePrepare.setCropyr(cropyr);
		 * balePrepare.setJutevariety(jutevariety); balePrepare.setBinnumber(binnumb);
		 * balePrepare.setBasis(basis); balePrepare.setCarryoverlossqty(carryforward);
		 * balePrepare.setCarryropeqty(carryforwarsrope); // farmer Bank Document
		 * balepreparationservice.create(balePrepare);
		 * redirectAttributes.addFlashAttribute("msg",
	...
	public ModelAndView saveJbaRate(HttpServletRequest request, RedirectAttributes redirectAttributes) {
		try {
			...
			if (grade1 != 0) {
				jbanorth.setGradewisepp1(grade1 + northern);
			}
			if (grade2 != 0) {
				jbanorth.setGradewisepp2(grade2 + northern);
			}
			if (grade3 != 0) {
				jbanorth.setGradewisepp3(grade3 + northern);
			}
			if (grade4 != 0) {
				jbanorth.setGradewisepp4(grade4 + northern);
			}
			if (grade5 != 0) {
				jbanorth.setGradewisepp5(grade5 + northern);
			}
			if (grade6 != 0) {
				jbanorth.setGradewisepp6(grade6 + northern);
			}
			if (grade7 != 0) {
				jbanorth.setGradewisepp7(grade7 + northern);
			}
			if (grade8 != 0) {
				jbanorth.setGradewisepp8(grade8 + northern);
			}
			...
			if (grade1 != 0) {
				jbasn.setGradewisepp1(grade1 + seminorthern);
			}
			if (grade2 != 0) {
				jbasn.setGradewisepp2(grade2 + seminorthern);
			}
			if (grade3 != 0) {
				jbasn.setGradewisepp3(grade3 + seminorthern);
			}
			if (grade4 != 0) {
				jbasn.setGradewisepp4(grade4 + seminorthern);
			}
			if (grade5 != 0) {
				jbasn.setGradewisepp5(grade5 + seminorthern);
			}
			if (grade6 != 0) {
				jbasn.setGradewisepp6(grade6 + seminorthern);
			}
			if (grade7 != 0) {
				jbasn.setGradewisepp7(grade7 + seminorthern);
			}
			if (grade8 != 0) {
				jbasn.setGradewisepp8(grade8 + seminorthern);
			}
			...
			if (grade1 != 0) {
				jbabr.setGradewisepp1(grade1 + bihar);
			}
			if (grade2 != 0) {
				jbabr.setGradewisepp2(grade2 + bihar);
			}
			if (grade3 != 0) {
				jbabr.setGradewisepp3(grade3 + bihar);
			}
			if (grade4 != 0) {
				jbabr.setGradewisepp4(grade4 + bihar);
			}
			if (grade5 != 0) {
				jbabr.setGradewisepp5(grade5 + bihar);
			}
			if (grade6 != 0) {
				jbabr.setGradewisepp6(grade6 + bihar);
			}
			if (grade7 != 0) {
				jbabr.setGradewisepp7(grade7 + bihar);
			}
			if (grade8 != 0) {
				jbabr.setGradewisepp8(grade8 + bihar);
			}
	...
	public ModelAndView saveJBAList(HttpServletRequest request, RedirectAttributes redirectAttributes
		...
		try {
			...
			System.out.println(e);
			redirectAttributes.addFlashAttribute("msg",
					"<div class=\"alert alert-dange\"><b>Failure!</b> Error While saving record. Please try againn</div>\r\n");
		}
	...
	public ModelAndView rawJuteProcurementAndPaymentMid(HttpServletRequest request,
			RedirectAttributes redirectAttributes, @RequestParam("tallySlipdoc") MultipartFile tallySlipdoc) {
...
//				}
	...
	/*
	 * @RequestMapping("juteProcurementList") public ModelAndView
	 * juteProcurementList(HttpServletRequest request) { ModelAndView mv = new
	 * ModelAndView("juteProcurementList"); List<RawJuteProcurementAndPayment>
	 * procurementList = new ArrayList<RawJuteProcurementAndPayment>(); try {
	 * procurementList = rawJuteProcurAndPayService.farmerDetailsList(); } catch
	 * (Exception e) { System.out.println(e); } mv.addObject("procurementList",
	 * procurementList); return mv; }
	 */
	...
	public ModelAndView saveVerification(HttpServletRequest request) {
		...
		try {
			...
			if (farmerById.getRegno() != null && farmerById.getIfsccode() != null && farmerById.getAccountno() != null
					&& farmerById.getFarmername() != null && farmerById.getAddress() != null
	...
	public ModelAndView saveCommercialCeilingPriceIntimation(HttpServletRequest request) {
		try {
			SimpleDateFormat formatter1 = new SimpleDateFormat("yyyy-MM-dd");
			...
			CommercialCeilingPriceIntimationModel addCommercialCeilingPriceIntimationModel = new CommercialCeilingPriceIntimationModel();
	...
	public ModelAndView saveTallySlipMid(HttpServletRequest request) {
		...
		try {
			...
			boolean procupdate = rawJuteProcurAndPayService.updateProcurementerror(status, is_verified, tallyNo,
					errors.trim(), region);
	...
	public ModelAndView updateBalePreparation(HttpServletRequest request, RedirectAttributes redirectAttributes) {
		...
		try {
			...
			String baleid = (String) request.getParameter("baleId");
			String place_of_packing = request.getParameter("place_of_packing");
			...
			String slip_no_from = request.getParameter("slip_no_from");
			String slip_no_to = request.getParameter("slip_no_to");
...
System.out.println(">>>>>>>>>>date>>>>>>>>>>>>>>>"+sqlDate);
			...
			int bale_no1 = Integer.parseInt(bale_no);
			balePreparation.setBale_no(bale_no1);
			balePreparation.setJute_grade(jute_grade);
...
//			}
			...
			int toCheckSlipNoInt = Integer.parseInt(slip_no_to);
			int fromCheckSlipNoInt = Integer.parseInt(slip_no_from);

			if (toCheckSlipNoInt > fromCheckSlipNoInt) {
				balePrepareService.update(balePreparation);
				redirectAttributes.addFlashAttribute("msg",
						"<div class=\"alert alert-success\"><b>Success !</b> Record updated successfully.</div>\r\n"
								+ "");
	...
	public String findGradeOnJuteVariety(HttpServletRequest request) {
		Gson gson = new Gson();
		List<String> result;
		result = rawJuteProcurAndPayService.findGradeOnJuteVariety(request.getParameter("variety"),
	...
	public ModelAndView editdistributiontally(HttpServletRequest request, RedirectAttributes redirectAttributes) {
		...
		try {
			String id = request.getParameter("id");
			DistributionoftallyslipModel distributiontallyslip = distributionoftallyslipService
	...
	public ModelAndView updateDistributionoftallyslip(HttpServletRequest request,
	...
	public ModelAndView editcommercialprice(HttpServletRequest request, RedirectAttributes redirectAttributes) {
		...
		try {
			String id = request.getParameter("id");
			CommercialCeilingPriceIntimationModel commercialCeilingPrice = commercialCeilingPriceIntimationService
					.find(Integer.parseInt(id));
	...
	public ModelAndView updateCommercialCeilingPriceIntimation(HttpServletRequest request,
			RedirectAttributes redirectAttributes) {
		ModelAndView mv = new ModelAndView("editcommercialprice");
		try {
			String id = request.getParameter("id");
	...
	public ModelAndView saveGradePriceOfMSP(HttpServletRequest request, RedirectAttributes redirectAttributes) {
		...
		try {
			...
			if (msp > 0) {
				...
				redirectAttributes.addFlashAttribute("msg",
						"<div class=\"alert alert-danger\"><b>Not saved !</b> Record Not Saved.</div>\r\n");
			}
			if (dubjuteVarietyB) {
...
//			balePreparation.setPacking_date(date1);

                                    ...
                                    <div class="row">
                                       <%--  <div class="col-sm-4 form-group">
                                        ...
                                        <div class="col-sm-4 form-group">
                                        	...
                                        	<input class="form-control" name="ropemade" id="ropemade" type="number" placeholder="Rope made" min="0" required onkeyup="ropeMadeLengthLen()">
										</div>
										<div class="col-sm-4 form-group">
											<label class="required">Rope Used</label>
                                        	<input class="form-control" name="ropeUsed" id="ropeUsed" type="number" placeholder="Rope Used" min="0" onblur="calculateRope()" onkeyup="ropeUsedLengthLen()" required>
										</div>
                                    </div>

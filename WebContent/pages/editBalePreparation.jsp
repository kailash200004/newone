                        ...
                        <div class="ibox">
                            ...
                            <div class="ibox-body">
                                <form action="updateBalePreparation.obj" method="POST" >
                                	<input type="hidden" id="id" name="id" value="<%=baleData.getBaleId()%>">
                                	<input type="hidden" id="juteVarietyjs" name="juteVarietyjs" value="<%=baleData.getJuteVariety()%>">
                                	<input type="hidden" id="juteVarietyGradejs" name="juteVarietyGradejs" value="<%=baleData.getJute_grade()%>">
                                    <div class="row">
                                      ...
                                      <%--  <div class="col-sm-4 form-group">
                                       ...
                                       <div class="col-sm-4 form-group">
											...
											<select name="cropyr" id="cropyr" class="form-control" >
												...
												<option <%if(baleData.getCropYear().equals("2021-2022")){out.print("selected");} %> value="2021-2022">2021-2022</option>
												<option <%if(baleData.getCropYear().equals("2022-2023")){out.print("selected");} %> value="2022-2023">2022-2023</option>											
											</select>
                                        </div>
                                      
                                       <div class="col-sm-4 form-group">
                                             <label>Bin number</label>
                                        	 <input class="form-control" name="binnumb" id="binnumb" type="number" placeholder="Bin Number" required onkeyup="checkLen()" value="<%=baleData.getBinNo()%>">
                                        </div> 
                                        
                                        <div class="col-sm-4 form-group" >
                                             <label>Basis</label>
                                        	 <select name="basis" id="basis" class="form-control" value="<%=baleData.getBasis()%>">
                                        		<option value="">-Select-</option>
                                        		<%-- <% 
                                        		...
                                        		<%
                                        		 ...
                                        		 %> --%>
                                        		<option <%if(baleData.getBasis().equals("msp")){out.print("selected");} %> value="msp">MSP</option>
												<option <%if(baleData.getBasis().equals("commercial")){out.print("selected");} %> value="commercial">Commercial</option>
                                        	 </select>
                                        </div>
                                        ...
                                        <div class="col-sm-4 form-group">
                                        	...
                                        	<select name="jutevariety" id="jutevariety" class="form-control">
                                        		<% 
                                        			if(baleData.getJuteVariety()!=null){
                                        		%>
                                        				<option value="<%baleData.getJuteVariety();%>" selected><%=baleData.getJuteVariety()%></option>
                                        		<%
                                        			}
                                        		 %>
                                        	</select>
										...
										<div class="col-sm-4 form-group">
                                        	...
                                        	<select name="jutegarde" id="jutegarde" class="form-control" value="<%=baleData.getJute_grade()%>">
                                        		<% 
                                        			if(baleData.getJute_grade()!=null){
                                        		%>
                                        				<option value="<%baleData.getJute_grade();%>" selected><%=baleData.getJute_grade()%></option>
                                        		<%
                                        			}
                                        		%>
                                        	</select>
										...
										<div class="col-sm-4 form-group">
                                        	...
                                        	<input class="form-control" name="fromCheckSlipNo" id="fromCheckSlipNo" type="text" placeholder="Bale Check SlipNo" value="<%=baleData.getSlipNoFrom()%>">
										</div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 form-group">
                                        	...
                                        	<input class="form-control" name="toCheckSlipNo" id="toCheckSlipNo" type="text" placeholder="Bale Check SlipNo" onblur="calculateNoOfBales()" value="<%=baleData.getSlipNoTo()%>">
										</div>
										
										<div class="col-sm-4 form-group">
											<label>Total Bales</label>
                                        	<input class="form-control" name="noOfBales" id="noOfBales" type="text" placeholder="Total bales" value="<%=baleData.getBale_no() %>" readonly >
										</div>
                                    </div>
